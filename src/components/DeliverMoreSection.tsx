// components/DeliverMoreSection.tsx
// =============================
import { motion } from "framer-motion";

export default function DeliverMoreSection() {
  return (
    <section className="bg-white py-24 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        >
          <img
            src="/deliver-more.png"
            alt="Driver delivering goods"
        ...
        >
          ...
          <p className="mt-5 text-gray-600 text-base md:text-lg max-w-md">
            Get nearby jobs that fit your vehicle.
          </p>
